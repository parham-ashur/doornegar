...
یکپارچه‌ است که سه چیز را کنار هم می‌بافد:
  ...
  ۲. شکافِ روایت‌ها — هر سمت این رویداد را چگونه روایت می‌کند، \
     چرا این زاویهٔ نگاه برایش اهمیت دارد، و این دو روایت کجا با هم اصطکاک دارند
...
- شخصِ راوی: راوی هیچ‌کدام از دو سمت نیست. حتی وقتی یک سمت آشکارا تحریف \
  می‌کند، بنویس «این سمت رویداد را این‌گونه روایت می‌کند»، نه «این سمت دروغ می‌گوید».
