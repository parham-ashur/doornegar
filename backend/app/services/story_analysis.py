...
{{
  ...
  "state_summary_fa": "<۳-۴ جمله — **جوهر موضعِ این سمت**: چه می‌گویند، چه می‌خواهند، چه را برجسته می‌کنند، چه را پنهان. نام رسانه‌ها، عبارت «رسانه‌های حکومتی/درون‌مرزی»، یا «این سمت» را نیاور — خواننده می‌تواند با کلیک روی مقاله، بفهمد کدام رسانه چه گفت. فقط خودِ روایت. جمله‌ها باید مستقیم بیان موضع باشند («اقدام آمریکا غیرقانونی و زیاده‌خواهانه است»)، نه انتساب («حکومتی‌ها می‌گویند اقدام آمریکا غیرقانونی است»). مثال غلط: «به گزارش نیویورک‌تایمز، ایران بر ادامهٔ دیپلماسی تأکید کرد» یا «رسانه‌های حکومتی بر پیروزی تأکید کردند» (هر دو نام/برچسب رسانه دارند). مثال درست: «ایران بر ادامهٔ دیپلماسی تأکید کرده و می‌کوشد تنش‌ها را مدیریت کند». یا null اگر هیچ رسانه‌ای از این سمت نباشد.>",
  "diaspora_summary_fa": "<۳-۴ جمله — **جوهر موضعِ این سمت**: همان قاعدهٔ بالا برای رسانه‌های برون‌مرزی. نام رسانه‌ها و برچسب «برون‌مرزی» نیاور، فقط روایت. مثال غلط: «به گزارش ایران‌اینترنشنال، حکومت در حال فروپاشی است». مثال درست: «حکومت در آستانهٔ فروپاشی است و دیگر توان کنترل اوضاع را ندارد». یا null.>",
