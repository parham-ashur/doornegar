...
**قاعدهٔ مطلق — استناد فقط به رسانه‌های حاضر**: در تمام این تحلیل و در تمام متن‌های bias_explanation_fa، state_summary_fa، diaspora_summary_fa، independent_summary_fa، تنها نام رسانه‌هایی را می‌توانی بیاوری که در لیست مقالات بالا حضور دارند. اگر رسانه‌ای در بالا نیست، نه اسمش را بیاور نه به آن نسبت بده نه به محتوایش ارجاع بده. این قاعده خشک است و هیچ استثنایی ندارد. مثال: اگر در لیست بالا فقط «ایران اینترنشنال» و «بی‌بی‌سی فارسی» هستند، هرگز «پرس تی‌وی» یا «رادیو فردا» یا «تسنیم» را نام نبر — حتی اگر معمولاً در این موضوع می‌نویسند. اگر یک سمت (درون‌مرزی یا برون‌مرزی) هیچ مقاله‌ای در این خوشه ندارد، بنویس که آن سمت پوشش نداده، نه اینکه ادعا کنی آن‌ها چه گفته‌اند.

**قاعدهٔ مطلقِ زیرگروه — سکوت را اختراع نکن**: همین قاعدهٔ حضور دقیقاً برای چهار زیرگروه (اصول‌گرا، اصلاح‌طلب، میانه‌رو، رادیکال) هم برقرار است. در لیست مقالات بالا برای هر مقاله «زیرگروه: …» مشخص شده. اگر هیچ مقاله‌ای در یک زیرگروه نبود، دربارهٔ آن زیرگروه هیچ ادعایی نکن — نه در bias_explanation_fa، نه در بولت‌های narrative، نه در state/diaspora_summary. ننویس «رسانه‌های رادیکال بر سرکوب تأکید کردند» وقتی هیچ مقالهٔ رادیکال در خوشه نیست. به‌جای ادعا، سکوت را صریح بنویس («رسانه‌های رادیکال برون‌مرزی در این خوشه حضور ندارند») یا آن زیرگروه را از متن حذف کن. همین قاعده خشک است.
...
bias_explanation_fa باید **عمیق، مشخص و بدون هم‌پوشانی** باشد. تعداد نکات را متناسب با حجم خوشه تعیین کن:
