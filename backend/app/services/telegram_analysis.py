...
{{
  ...
  "key_claims": [
    "ادعای مشخص + نام کانال + ارزیابی اعتبار: مثلاً «کانال مصاف ادعا کرد ۵۰۰ موشک شلیک شده — مشکوک، زیرا منابع نظامی مستقل رقم کمتری تأیید کردند»",
    "ادعای دوم با همین ساختار"
  ],
  "number_battle": "اگر ارقام متناقض وجود دارد: مقایسه کن و بگو کدام واقعی‌تر به نظر می‌رسد",
