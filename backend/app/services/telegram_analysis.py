...
{{
  ...
  "predictions": [
    {{"text": "پیش‌بینی = گزاره‌ای دربارهٔ اتفاقِ آینده. فعلِ آینده‌دار دارد (خواهد، می‌شود، رخ می‌دهد). ۴ تا ۶ پیش‌بینی متمایز بده — نه یکی، نه دو تا. ممنوع: ذکرِ نامِ کانال در متن («کانال X پیش‌بینی کرد»)، نقل‌قول مستقیم («گفت که …»)، یا پیش‌بینیِ فرا-رسانه‌ای («کانال‌های اپوزیسیون Y خواهند گفت»). فقط جوهرِ اتفاق را بنویس: «آتش‌بس تا پایان ماه می‌شکند»، «تلفات از ۵۰۰ نفر می‌گذرد»، «مذاکرات شکست می‌خورد».", "supporters": ["نام کانال‌هایی که مشابه پیش‌بینی کردند — فقط برای backend، نمایش داده نمی‌شود"]}},
    {{"text": "پیش‌بینی دوم دربارهٔ رویدادی متفاوت از پیش‌بینی اول — تکرار ممنوع", "supporters": ["کانال ۱"]}},
    {{"text": "پیش‌بینی سوم", "supporters": ["کانال ۲"]}},
    {{"text": "پیش‌بینی چهارم", "supporters": ["کانال ۳"]}}
  ],
  "worldviews": {{
