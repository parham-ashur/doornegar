...
{{
  ...
  "key_claims": [
    "ادعا = اطلاعاتی که یک طرف مدعی دانستنِ آن است و بقیه نمی‌دانند یا انکار می‌کنند — نه پیش‌بینی. فعلِ آینده ممنوع؛ ادعا دربارهٔ گذشته یا حالِ واقعی است. ممنوع: ذکرِ نامِ کانال در متن، نقل‌قول مستقیم، و پیشوندِ «موضوع: X |». فقط جوهرِ ادعا را بنویس: «۵۰۰ موشک در حملهٔ دیشب شلیک شده»، «فرماندهٔ سپاه کشته شده»، «مذاکرات مخفیانه در عمان در جریان است». اگر ادعا با پیش‌بینی اشتباه گرفته شد (فعلِ آینده دارد)، به predictions منتقل کن.",
    "ادعای دوم. اگر چند طرف دربارهٔ یک موضوع (مثلاً شمارِ تلفات) ارقام متفاوت می‌دهند، هر دو ادعا را بیاور تا خواننده مقایسه کند — اما بدون «کانال X گفت»."
  ],
