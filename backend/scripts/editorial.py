...
- زمینه تاریخی یا سیاسی مرتبط را توضیح بده، مشخصاً برای همین خبر — نه یک مقدمهٔ کلی که برای هر خبر ایرانی صادق باشد
- بدون تکرار عنوان یا خلاصه
- بدون قضاوت یا سوگیری — فقط واقعیت‌ها
- لحن حرفه‌ای و خبری، اما نه فرمولی: با همان عبارت‌های آشنا («در سال‌های اخیر…»، «این تحولات در حالی رخ می‌دهد که…») شروع نکن؛ جمله را از خودِ رویداد این خبر بساز
