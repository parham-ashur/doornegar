...
const DIMENSIONS: { key: string; label: string; description: string; low: string; high: string }[] = [
  ...
  { key: "audience_accountability", label: "پاسخگویی به مخاطب", description: "آیا رسانه مکانیزم بازخورد، تصحیح خطا، و پاسخگویی به مخاطبان دارد — یا یک‌طرفه پیام ارسال می‌کند", low: "بدون پاسخگویی", high: "پاسخگوی فعال" },
