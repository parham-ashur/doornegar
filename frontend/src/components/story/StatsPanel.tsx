  ...
  return (
    <div id={containerId} dir="rtl" className="space-y-5">
      ...
      {storyId && !showTelegram && (
        ...
        >
          <div className="shrink-0 w-8 h-8 bg-[#2AABEE]/15 dark:bg-[#2AABEE]/20 flex items-center justify-center">
            ...
            <div className="space-y-1.5">
              {stateFraming && (
                <div className="flex items-start gap-2">
                  <span className="shrink-0 w-1.5 h-1.5 mt-1.5 bg-inside-border" />
              ...
              {diasporaFraming && (
                <div className="flex items-start gap-2">
                  <span className="shrink-0 w-1.5 h-1.5 mt-1.5 bg-outside-border" />
                  <span className="text-slate-500">
            ...
            {NARRATIVE_GROUP_ORDER.map((group) => {
              ...
              return (
                <div key={group}>
                  ...
                  <p className="text-[13px] leading-6 text-slate-500 dark:text-slate-400 ps-4">
